...
namespace Cirrious.MvvmCross.Dialog.Droid
{
    public static class MvxAndroidDialogViewControllerBinderExtensions
    {
        ...
        {
            droidView.AddBindings(element, droidView.DataContext, descriptionText);
            return element;
        }
        ...
        {
			droidView.AddBindings(element, droidView.DataContext, descriptions);
            return element;
        }
                                          ...
                                          string bindingText)
        {
            ...
            {
                droidView.BindingContext.RegisterBinding (binding);
            }
        }
